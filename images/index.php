...
<body background="img/landing-devices-bg.png">



<button onClick="document.getElementById('modal-wrapper').style.display='block'" style="width:200px; margin-top:193px; margin-left:120px;"></button>
...
<button onClick="document.getElementById('modal-wrapper2').style.display='block'" style="width:200px; margin-top:262px; margin-left:120px;"></button>
...
<button onClick="document.getElementById('modal-wrapper3').style.display='block'" style="width:200px; margin-top:328px; margin-left:120px;"></button>
...
<button onClick="document.getElementById('modal-wrapper4').style.display='block'" style="width:200px; margin-top:390px; margin-left:120px;"></button>
...
<button onClick="document.getElementById('modal-wrapper5').style.display='block'" style="width:200px; margin-top:443px; margin-left:120px;"></button>
...
<button onClick="document.getElementById('modal-wrapper6').style.display='block'" style="width:200px; margin-top:513px; margin-left:120px;"></button>
